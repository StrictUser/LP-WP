	...
	<div class="wrap">
		...
		<form method="post" action="options.php">
			...
			<table class="form-table">
				 ...
				 */
				?>
				<tr valign="top"><th scope="row"><?php _e( 'Color scheme', 'sampletheme' ); ?></th>
					<td>
						...
						<label class="description" for="sample_theme_options[selectinput]"><?php _e( 'Choose color of the theme', 'sampletheme' ); ?></label>
					</td>
				</tr>
